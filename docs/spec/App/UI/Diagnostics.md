...
| codec ステップ | `diagnostics-live-pipeline` | `pipeline-codec-step` | Codec | `preferredTransmitCodec`, `selectedTransmitCodec` | requested と selected を表示 | fallback は warning |
...
| VADGate | `pipeline-effect-stage-vad-gate` | VADGate | speech / silent / muted と感度 preset |
