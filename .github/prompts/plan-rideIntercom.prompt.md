...
- 完了済み（Step 13 の一部）: transport state 遷移を `HandoverController` 経由に統一
- 進捗コミット: `98e3f23` `c32ac93` `4bcdb7d` `58edd0f` `70f76d1` `036eafb`
- 次アクション: Step 24 を継続し、送信側（VAD/Transmission）のユースケース境界を分離する
