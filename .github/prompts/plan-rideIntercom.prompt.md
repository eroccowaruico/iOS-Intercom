...
2. [docs/ios-intercom-spec-v1.md](docs/ios-intercom-spec-v1.md) の要求と [docs/implementation-status.md](docs/implementation-status.md) の現状を統合し、「維持すべき機能契約」を機械判定可能な受け入れ条件へ再定義する。設計やクラス構造は固定対象に含めない。*blocks all later steps*
...
- /Users/naohito/source/RideIntercom/docs/implementation-status.md — 現在地と未実装範囲。P1-P4バックログの基準
